...
namespace EasyShortVideo\Ixigua\OpenPlatform\Kernel;
...
abstract class AccessToken implements AccessTokenInterface
{
     ...
     * @var string
     */
    protected $cachePrefix = 'ixigua_open_platform.';
     ...
     * 设置授权的Code
     * @param string $code
     * @return \EasyShortVideo\Tiktok\OpenPlatform\Kernel\AccessToken
     */
